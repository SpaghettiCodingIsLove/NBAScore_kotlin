 ...
 * Use the [FragmentDivisions.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentDivisions : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentDivisions.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentDivisions().apply {
