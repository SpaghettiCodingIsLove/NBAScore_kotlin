...
class FragmentGameStats : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homeTeam.text = game?.home_team?.abbreviation
        visitorTeam.text = game?.visitor_team?.abbreviation
        ...
        homeTeamImage.setImageDrawable(requireContext().resources.getDrawable(
            requireContext().resources.getIdentifier(game?.home_team?.abbreviation?.toLowerCase(), "drawable", getActivity(
                context
            )?.packageName)
        ))

        visitorTeamImage.setImageDrawable(
            requireContext().resources.getDrawable(requireContext().resources.getIdentifier(game?.visitor_team?.abbreviation?.toLowerCase(), "drawable", getActivity(
            context
        )?.packageName)))
        ...
        myAdapter = StatsAdapter(viewModel.allStats)
